        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="https://wa.me/5522998458832" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-background/10 flex items-center justify-center hover:bg-primary hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#combos" className="text-background/70 hover:text-primary transition-colors flex items-center gap-2">
                  <ChevronRight className="w-4 h-4" /> Nossos Combos
                </a>
              </li>
              <li>
                <a href="#como-funciona" className="text-background/70 hover:text-primary transition-colors flex items-center gap-2">
                  <ChevronRight className="w-4 h-4" /> Como Funciona
                </a>
              </li>
              <li>
                <a href="#faq" className="text-background/70 hover:text-primary transition-colors flex items-center gap-2">
                  <ChevronRight className="w-4 h-4" /> Perguntas Frequentes
                </a>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-background/70">
                ...
                <div>
                  ...
                  <a href="https://wa.me/5522998458832" className="hover:text-primary transition-colors">(22) 99845-8832</a>
                </div>
              </li>
              <li className="flex items-start gap-3 text-background/70">
